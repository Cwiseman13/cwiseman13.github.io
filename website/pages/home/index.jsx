...
export default function HomePage() {
  return (
    <div className="p-home">
      <BasicHero
        brand="consul"
        heading="Identity and Data Governance for Public Cloud"
        content="Unify Compliance and Platform Configuration Monitoring"
        links={[
          {
            text: 'Read the Docs',
            url: '/docs',
          ...
          {
            text: 'Learn more about Sonrai secures your cloud offerings',
            url: '/#cloud-offerings',
            type: 'inbound',
          },
        ]}
      ...
      <ProductFeaturesList
        ...
        features={[
          ...
          {
            title: 'Unify Compliance and Platform Configuration Monitoring',
            content:
